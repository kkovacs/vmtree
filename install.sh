...
if [[ ! -f /usr/bin/caddy ]]; then
	until apt-get install -y bash-completion caddy curl dnsutils git gron htop jq less man openssh-server psmisc rsync socat tig unattended-upgrades unzip vim-nox wget zfsutils-linux; do sleep 1; done;
