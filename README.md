...
- you are not _forced_ to use VSCode (but you can). (Hello `vim`! 😁)
...
- As of now, there is no support company, foundation, etc behind this open-source project. On the other hand, it's barely 400 lines of `bash` code (including comments), so I'm pretty sure your DevOps team can deal with it if I get hit by a bus.
