...
- You can use it on an Internet-based server or on-premise behind a corporate firewall: it just needs the wildcard DNS settings and a wildcard TLS certificate. (We do use it both ways.)
